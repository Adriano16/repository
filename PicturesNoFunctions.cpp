...
int main()
    ...
    txLine(50-0.15*50, 500-1.0*300, 50-0.5*50, 500-0.8*300);
    ...
    txLine      (420+150*0.50, 500-150*0.25, 420+150*0.50, 500-150*0.75);
    txLine      (420+150*0.25, 500-150*0.50, 420+150*0.75, 500-150*0.50);

    txSetColor (TX_ORANGE);
    txSetFillColor (TX_ORANGE);
    txEllipse (650, 455, 650+70, 455+70/3);
    txCircle (650, 455, 0.2*70);
    txRectangle (650+70*0.2, 455+70/3*0.5, 650+70*0.3, 455+2*70/3);
    txRectangle (650+70*0.7, 455+70/3*0.5, 650+70*0.8, 455+2*70/3);
